...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '归淮RevaHuai', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个创作者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://revahuai.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 归淮', // 网站关键词 英文逗号隔开
